        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              <p>Current Member : {{$count}} / KMG : {{$kmg_member}} / ALS : {{$als_member}}</p>
              <p>IG View : {{$ig_view}} / IG Regis : {{$ig_regis}}</p>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th scope="col">Jadwal BL</th>
            <th scope="col">Session</th>
            <th scope="col">Materi LnT</th>
            <th></th>
            <th></th>
            <th></th>
            <th></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <form method="POST" action="{{ route('change_session', $data) }}">
                @csrf
                <button type="submit" class="btn btn-outline-primary btn-sm">Change session</button>
              </form>
            </td>
            <td>
              <form method="POST" action="{{ route('reset_pass', $data) }}">
                @csrf
                <button type="submit" class="btn btn-outline-primary btn-sm">Reset Pass</button>
              </form>
            </td>
            <td>
            ...
            <td>
              <button type="submit" data-catid="{{$data->id}}" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#delete">Delete</button>
            </td>
          </tr>
          @endforeach
          </tr>
