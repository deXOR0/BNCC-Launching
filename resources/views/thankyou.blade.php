    ...
    <section class="payment">
        <div class="container payment-wrapper">
            ...
            <div class="row payment-box">
                <p class="payment-title col-md-12">You Have Been Registered Successfully</p>

                <p class="text-center w-100">Thank you for registering, you are now registered as member of BNCC.</p>
            </div>
