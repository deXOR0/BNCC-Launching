...
!(function (t, e) {
    ...
    var e = (function (t) {
            var e = "ControlSidebar",
                ...
                A = (function () {
                    ...
                    return (
                        ...
                        (n.toggle = function () {
                            t("body").hasClass(h) || t("body").hasClass(f)
                                ? this.collapse()
                                : this.show();
                        }),
                        (n._init = function () {
                        ...
                        (n._fixScrollHeight = function () {
                            var e = {
                                ...
                                i = Math.abs(
                                    e.window + t(window).scrollTop() - e.scroll
                                ),
                            ...
                            t("body").hasClass(u) &&
                                ...
                                (t("body").hasClass(C) ||
                                    ...
                                    t("body").hasClass(w) ||
                                    t("body").hasClass(x)) &&
                                    "fixed" === t(c).css("position") &&
                                    (r = !0),
                                0 === n && 0 === i
                                    ? (t(o).css("bottom", e.footer),
                                      t(o).css("top", e.header),
                                      t(o + ", " + o + " " + a).css(
                                          "height",
                                          e.window - (e.header + e.footer)
                                      ))
                                    : i <= e.footer
                                    ? !1 === r
                                        ? (t(o).css("bottom", e.footer - i),
                                          t(o + ", " + o + " " + a).css(
                                              "height",
                                              e.window - (e.footer - i)
                                          ))
                        ...
                        (n._fixHeight = function () {
                            ...
                            if (t("body").hasClass(u)) {
                                ...
                                (t("body").hasClass(C) ||
                                    ...
                                    t(o + " " + a).css("height", s),
                                    "undefined" !=
                                        typeof t.fn.overlayScrollbars &&
                                        t(o + " " + a).overlayScrollbars({
                                            className: this._config
                                                .scrollbarTheme,
                                            sizeAutoCapable: !0,
                                            scrollbars: {
                                                autoHide: this._config
                                                    .scrollbarAutoHide,
                                                clickScrolling: !0,
                                            },
                                        });
                    ...
                    return (
                        (i.fixLayoutHeight = function (e) {
                            ...
                            !0 === d && (d = 0),
                                !1 !== d &&
                                    (l == s.control_sidebar
                                        ? t(a).css("min-height", l + d)
                                        : l == s.window
                                        ? t(a).css(
                                              "min-height",
                                              l + d - s.header - s.footer
                                          )
                                        : t(a).css(
                                              "min-height",
                                              l + d - s.header
                        ...
                        (i.fixLoginRegisterHeight = function () {
                            ...
                            else if (0 !== t(h + ", " + f).length) {
                                var e = t(h + ", " + f).height();
                                t("body").css("min-height") !== e &&
                                    t("body").css("min-height", e);
                            }
                        }),
                        (i._init = function () {
                        ...
                        (i._isFooterFixed = function () {
                            return (
                                "fixed" === t(".main-footer").css("position")
                            );
                        }),
        ...
        n = (function (t) {
                    ...
                    return (
                        (n.expand = function () {
                            this._options.autoCollapseSize &&
                                t(window).width() <=
                                    this._options.autoCollapseSize &&
                                t(r).addClass(h),
                                t(r).removeClass(d).removeClass(f),
                                this._options.enableRemember &&
                                    localStorage.setItem("remember" + i, h);
                        ...
                        (n.collapse = function () {
                            this._options.autoCollapseSize &&
                                t(window).width() <=
                                    this._options.autoCollapseSize &&
                                t(r).removeClass(h).addClass(f),
                                t(r).addClass(d),
                                this._options.enableRemember &&
                                    localStorage.setItem("remember" + i, d);
                            var e = t.Event(s.COLLAPSED);
                            t(this._element).trigger(e);
                        }),
                        (n.toggle = function () {
                        ...
                        (n.remember = function () {
                            this._options.enableRemember &&
                                (localStorage.getItem("remember" + i) == d
                        ...
                        (e._jQueryInterface = function (i) {
                            return this.each(function () {
                                ...
                                n ||
                                    ...
                                    "string" == typeof i &&
                                        i.match(/collapse|expand|toggle/) &&
                                        n[i]();
                            });
                        }),
                        e
            ...
            return (
                t(document).on("click", a, function (e) {
                    ...
                    "pushmenu" !== t(i).data("widget") && (i = t(i).closest(a)),
                ...
                h = (function () {
                    ...
                    return (
                        ...
                        (i._expandSidebar = function () {
                            t("body").hasClass(c) &&
                                t(this._config.sidebarButtonSelector).PushMenu(
                                    "expand"
                                );
                        }),
                        (e._jQueryInterface = function (i) {
                    ...
                    return (
                        ...
                        (i._init = function () {
                            ...
                            t(n)
                                ...
                                .parents("li")
                                .toggleClass(s),
                                t(n).on("change", "input:checkbox", function (
                                    i
                                ) {
                                    e.toggle(t(i.target));
                                });
        ...
        r = (function (t) {
            var e = "CardWidget",
                ...
                u = (function () {
                    function e(e, i) {
                        (this._element = e),
                            (this._parent = e.parents(h.CARD).first()),
                            e.hasClass(o) && (this._parent = e),
                            (this._settings = t.extend({}, f, i));
                    }
                    var i = e.prototype;
                    return (
                        (i.collapse = function () {
                            ...
                            this._parent
                                .addClass(r)
                                .children(h.CARD_BODY + ", " + h.CARD_FOOTER)
                                .slideUp(
                        ...
                        (e._jQueryInterface = function (i) {
                            ...
                            n ||
                                ...
                                i.match(
                                    ...
                                    ? n[i]()
                                    : "object" == typeof i && n._init(t(this));
                        }),
                        e
                    );
                })();
            return (
                t(document).on("click", h.DATA_COLLAPSE, function (e) {
                    e && e.preventDefault(),
                        u._jQueryInterface.call(t(this), "toggle");
                }),
                t(document).on("click", h.DATA_REMOVE, function (e) {
                    e && e.preventDefault(),
                        u._jQueryInterface.call(t(this), "remove");
                }),
                t(document).on("click", h.DATA_MAXIMIZE, function (e) {
                    e && e.preventDefault(),
                        u._jQueryInterface.call(t(this), "toggleMaximize");
                }),
                (t.fn[e] = u._jQueryInterface),
                (t.fn[e].Constructor = u),
                (t.fn[e].noConflict = function () {
        ...
        l = (function (t) {
                        ...
                        (i.load = function () {
                            this._addOverlay(),
                                ...
                                t.get(
                                    ...
                                    function (e) {
                                        this._settings.loadInContent &&
                                            ("" !=
                                                this._settings.sourceSelector &&
                                                (e = t(e)
                                                    .find(
                                                        this._settings
                                                            .sourceSelector
                                                    ...
                                                    .html()),
                                            this._parent
                                                .find(this._settings.content)
                                                .html(e)),
                                            this._settings.onLoadDone.call(
                                                t(this),
                                                e
                                            ),
                                            this._removeOverlay();
            ...
            return (
                t(document).on("click", o.DATA_REFRESH, function (e) {
                    e && e.preventDefault(),
        ...
        c = (function (t) {
            ...
            return (
                t(s + " " + a).on("click", function (e) {
                    e.preventDefault(),
                        e.stopPropagation(),
                        c._jQueryInterface.call(t(this), "toggleSubmenu");
                }),
                    ...
                    return (
                        (i.create = function () {
                            ...
                            if (
                                ...
                                var o = t('<button data-dismiss="toast" />')
                                    .attr("type", "button")
                                ...
                                null == this._config.title &&
                                    o.toggleClass("ml-2 ml-auto"),
                                    i.append(o);
                            }
                            e.append(i),
                                null != this._config.body &&
                                    e.append(
                                        t('<div class="toast-body" />').html(
                                            this._config.body
                                        )
                                    ),
                        ...
                        (i._getContainerId = function () {
                            return this._config.position == f
                                ? s
                                : this._config.position == u
                                ? o
                                : this._config.position == g
                                ? a
                                : this._config.position == p
                                ? r
                                : void 0;
                        }),
                        (i._prepareContainer = function () {
                            ...
                            this._config.fixed
                                ? t(this._getContainerId()).addClass("fixed")
                                : t(this._getContainerId()).removeClass(
                                      "fixed"
                                  );
                        }),
